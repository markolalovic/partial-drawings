...
% moji makroji
\newcommand{\abovesym}[1]{\tilde{#1}} %{\tilde{#1}}%
\newcommand{\undersym}[1]{\underaccent{\tilde}{#1}} %{\utilde{#1}}%
\newcommand{\rectansym}{\Box}
\newcommand{\quadsym}{\Diamond} %{\diamond}
...
\centering
\resizebox{8cm}{!}{%
\input{./tikz/only-two-obstacles-1.tikz}
}
...
\centering
\resizebox{8cm}{!}{%
\input{./tikz/only-two-obstacles-2.tikz}
}
...
\centering
\resizebox{6cm}{!}{%
\input{./tikz/points-in-one-sided-convex-position.tikz}
}
\end{figure}
...
\centering
\resizebox{8cm}{!}{%
\input{./tikz/proof-k33-trapezoid.tikz}
}
\end{figure}
\end{frame}
%------------------------------------------------
...
\begin{center}
%\resizebox{6cm}{!}{%
\input{./tikz/tessellation-is-dependent-on-c.tikz}
%}
\end{center}
\end{figure}
\end{frame}
...
\begin{center}
\resizebox{6cm}{!}{%
\input{./tikz/tessellation-transformation.tikz}
}
\end{center}
\end{figure}
\end{frame}
...
\begin{center}
%\resizebox{6cm}{!}{%
\input{./tikz/tessellation-transformation-is-dependent-on-c.tikz}
%}
\end{center}
\end{figure}
\end{frame}
...
\begin{center}
\resizebox{8cm}{!}{%
\input{./tikz/corner-regions-1.tikz}
}
\end{center}
...
\begin{center}
\resizebox{4cm}{!}{%
\input{./tikz/half-shadows-2.tikz}
}
\end{center}
...
\centering
\resizebox{4cm}{!}{%
\input{./tikz/number-of-points.tikz}
}
